...
import com.UMS.NotificationService.dto.ExecptionDTO;
...
public class GlobalExecptionHandler {
    ...
    public ResponseEntity<ExecptionDTO> execptionNotificationNotFoundException(Exception e, WebRequest webRequest){
